...
public class PnDisplayYoungChildInfoGUI extends JPanel implements ActionListener{
	...
	public PnDisplayYoungChildInfoGUI(MainMenuGUI mainMenu, PnSelectPersonGUI pnSelect) {
	...
	public void setPanel() {
		...
		lbParent1.setBounds(_lblbX, lbPostcode.getY() + lbPostcode.getHeight() + _gapY, _lblbWidth, _lblbHeight);
